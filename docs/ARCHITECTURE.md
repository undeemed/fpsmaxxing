...
The recorded samples themselves are not re-derived, and the hypothesis is held to its length rather than its content, so a rewrite of the measurements together with the verdict they imply - or of the hypothesis text within its bounds - passes replay.
