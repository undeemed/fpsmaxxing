...
The recorded samples themselves are not re-derived, so detecting a rewrite of the measurements together with the verdict they imply needs a signed or hash-chained journal, which the alpha does not have.
